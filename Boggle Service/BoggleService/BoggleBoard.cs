...
namespace Boggle
{
    ...
    public class BoggleBoard
    {
        ...
        /// <summary>
        /// Returns the score for a given word, based on the word's length and presence (or lack thereof)
        /// in the given dictionary. 
        /// 
        /// Does not account for whether a player has already played the word.
        /// </summary>
        public int GetScoreForWord(string word, ISet<string> dictionary)
        {
            ...
            if (CanBeFormed(word) && dictionary.Contains(word))
            {
